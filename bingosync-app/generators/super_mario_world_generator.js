...
var bingoList=[];
bingoList[1]=[{
name:"Defeat 6/7 Koopa Kids",types:[]}];
bingoList[2]=[{
name:"Open star road from Valley Of Bowser",types:["yoshi1"]}];
bingoList[3]=[{
name:"All 14 exits in Forest Of Illusion",types:[]}];
bingoList[4]=[{
name:"Open Chocolate Island 3 useless exit",types:[]}];
bingoList[5]=[{
...
name:"Sunken Ship - get 1 life from star",types:[]}];
bingoList[22]=[{
name:"99 lives",types:[]},{
name:"Blue Switch - get 8 silver coins",types:[]},{
name:"Butter Bridge 1 - get 4 lives from turtles",types:[]},{
name:"Chocolate Island 2 - get 11 bubble mushrooms",types:[]}];
bingoList[23]=[{
