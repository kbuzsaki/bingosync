...
[
    ...
    {name: "Read the lore tablet in Howling Cliffs", types: ["cliffs"]}, 
...
[
    ...
    {name: "Read the lore tablet in Ancient Basin", types: ["basin"]}, 
    {name: "Check the journal above Mantis Village", types: ["fungal"]}, 
    {name: "Read both Pilgrim's Way lore tablets", types: ["fungal"]}
],
[
...
[
    ...
    {name: "Obtain two Unbreakable charms", types: []}, 
    {name: "Obtain Glowing Womb or Weaversong", types: []}, 
    {name: "Obtain Howling Wraiths", types: []}, 
    {name: "Sit down in Hidden Station", types: ["basin"]}, 
    {name: "Read three lore tablets in Greenpath", types: ["greenpath"]}, 
    {name: "Read both lore tablets in Mantis Village", types: ["fungal"]}
],
[
...
[
    ...
    {name: "Crystal Crawler Journal Entry", types: ["peak", "journal"]}, 
...
[
    ...
    {name: "Kill 4 Mimics", types: ["cdash"]}, 
...
[
    ...
    {name: "Goam and Garpede Journal Entries", types: ["journal", "deepnest"]}, 
...
[
    {name: "Read the lore tablet in Kingdom's Edge (requires Spore Shroom)", types: ["edge"]}, 
...
[
    ...
    {name: "Read both lore tablets in Soul Sanctum", types: ["sanctum"]}, 
...
[
    ...
    {name: "Read two lore tablets in City of Tears proper (No sub areas)", types: ["watchers", "city"]}, 
