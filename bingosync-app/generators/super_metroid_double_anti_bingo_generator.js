...
name:"Destroy at least 1 of the 4 Golden Statues",types:["statueroom"]},{
...
name:"Visit Lower Norfair Elevator",types:["norfairelev","hijump"]},{
...
bingoList[20]=[{
name:"Activate all 5 Map Stations",types:["crateriamap","wsmap","norfairmap","maridiamap"]},{
...
name:"Destroy at least 2 of the 4 Golden Statues",types:["statueroom"]}];
bingoList[21]=[{
...
name:"Defeat Golden Torizo",types:["gt","screwattack","norfairelev"]},{
name:"40+ Power Bombs",types:["powerbomb"]},{
name:"Maridia Reserve Tank",types:["reservetank"]}];
bingoList[22]=[{
name:"Defeat Golden Torizo and Spore Spawn",types:["gt","sporespawn","screwattack","norfairelev"]},{
name:"Defeat Ridley",types:["ridley","norfairelev"]},{
...
name:"Collect all 15 Norfair Power Bombs",types:["powerbomb","norfairelev"]},{
...
name:"Norfair Super Missile",types:["supermissile","norfairelev"]},{
...
name:"Defeat Crocomire and Ridley",types:["crocomire","ridley","norfairelev"]},{
...
name:"Collect all 4 Norfair Energy Tanks",types:["energytank","ridley","norfairelev"]},{
