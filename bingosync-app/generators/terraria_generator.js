...
bingoList[1] = [
  ...
  { name: "Get thorn'd to death", types: [] },
];
bingoList[2] = [
  { name: "Obtain 2 different Spears", types: [] },
  { name: "Obtain 1 Platinum Coin", types: [] },
...
bingoList[9] = [
  ...
  { name: "Obtain 5 unique hooks", types: [] },
...
bingoList[19] = [
  ...
  { name: "Kill 10 enemies with the ruler", types: [] },
  { name: "Have 5 minions (not sentrys) summoned at once", types: ["ME.6.1"] },
  { name: "Craft a Hamaxe + any kind of Phaseblade", types: ["ME.13"] },
  { name: "Craft the Phoenix Blaster", types: ["gun"] },
