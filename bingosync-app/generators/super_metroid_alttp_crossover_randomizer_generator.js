...
var bingoList = [
    ...
    "Activate Upper Norfair Energy Recharge Station",
    ...
    "Collect Grapple Beam or Hookshot",
    "Collect Ice Beam or Ice Rod",
    "Collect Rod + Cane of opposite colors",
    "Collect Rod + Cane of the same color",
    "Collect Sahasrahla's Prize",
    "Collect Space Jump or Flute",
    "Collect Speed Booster or Pegasus Boots",
    "Collect a Medallion",
    "Collect both items in the left sand pit",
    "Collect both items in the right sand pit",
    "Collect item at Byrna Cave",
    "Collect item at Death Mountain Lonely Island",
    "Collect item at Lake Hylia Island",
    "Collect item at Lumberjack Tree",
    "Collect item at Mimic Cave",
    ...
    "Finish near Spazer, Charge, Ice, Wave, or Plasma Pedestal",
    "Freeze a Bomb Slug",
    "Freeze a Dodongo",
    "Freeze a space pirate",
    "Fully explore the Landing Site",
    "Fully explore the inside of Wrecked Ship",
    "Go bowling",
    ...
    "Upgrade Shield",
    "Upgrade Sword",
    "Visit Brinstar, Maridia, and Wrecked Ship Map Stations",
    ...
    "Visit Wrecked Ship Map Station",
