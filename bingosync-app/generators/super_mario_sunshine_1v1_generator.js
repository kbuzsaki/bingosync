...
var bingoList = [];
bingoList[1] = [
{ name: "11 Blue Coins from Delfino Plaza"},
{ name: "5 Linked Blue Coin Pairs"},
{ name: "15 Blue Coins from M Graffiti"},
{ name: "100 Coin Shine from Pianta"},
{ name: "23 Blue Coins from Ricco"}
];
bingoList[2] = [
{ name: "Two 100 Coin Shines"},
{ name: "150 Yellow Coins from Delfino OR 50 Yellow Coins from 2 Levels"},
{ name: "Bianco 4 Fluddless"},
{ name: "Ricco 3 Hoverless"}
];
bingoList[3] = [
{ name: "18 Lives"},
{ name: "20 Lives"},
{ name: "100 Coin Shine from Ricco"},
{ name: "3 Red Coin Shines"},
{ name: "1 Hidden Shine in Bianco"}
];
bingoList[4] = [
{ name: "15 Blue Coins from Bianco"},
{ name: "3 Boss Shines"},
{ name: "1 Hidden Shine in Ricco"},
{ name: "Pianta 3 NO Damage Taken"},
{ name: "Pass through 5 Doors in Sirena"}
];
bingoList[5] = [
{ name: "3 Fruit Lady Blue Coins"},
{ name: "5 NPC Blue Coins"},
{ name: "10 Blue Coins from Sirena"},
{ name: "4 Shines from Sirena"},
{ name: "3 Secret Shines"}
];
bingoList[6] = [
{ name: "1 Turbo Nozzle Unlock"},
{ name: "3 Hidden Shines"},
{ name: "15 Blue Coins from Gelato"},
...
bingoList[8] = [
{ name: "20 Blue Coins from Bianco"},
{ name: "18 Blue Coins from Pianta"},
...
{ name: "100 Coin Shine from Sirena"}
];
bingoList[11] = [
{ name: "8 Shines from Delfino Plaza"},
{ name: "9 Shines from Delfino Plaza"},
{ name: "1 Hidden Shines in Sirena"},
{ name: "4 Secret Shines"},
{ name: "8 Linked Blue Coin Pairs"}
];
bingoList[12] = [
{ name: "1 Hidden Shine in Pinna"},
{ name: "All Basket Blues in Pinna OR 4 Fruit Ladies"},
{ name: "Enter 6 Pipes and Collect their Shines"},
{ name: "5 Boss Shines"}
];
bingoList[13] = [
{ name: "Pinna 4 Sprayless"},
{ name: "100 Coin Shine from Pinna"},
{ name: "100 Coin Shine from a Secret level"},
{ name: "1 Hidden Shine from Pianta"}
];
bingoList[14] = [
...
{ name: "Defeat Shadow Mario in Pinna"},
{ name: "20 Blue Coins from 2 Levels"}
];
bingoList[16] = [
{ name: "5 Shines from Bianco"},
{ name: "7 Blue Bird Blue Coins"},
{ name: "6 Shines from Gelato OR Bianco 6 Reds Hoverless"},
...
{ name: "1 Butterfly Blue (No Pinna)"}
];
bingoList[18] = [
...
bingoList[19] = [
{ name: "6 Boss Shines"},
{ name: "100 Coin Shine from Noki"},
{ name: "4 Shines from Noki"},
{ name: "Collect 26 Shines"}
];
bingoList[20] = [
{ name: "Defeat the Eel"},
...
{ name: "20 Blue Coins from Sirena"},
{ name: "6 Hidden Shines"}
];
bingoList[23] = [
{ name: "Defeat Shadow Mario in Bianco"},
{ name: "Defeat Shadow Mario in Pianta"},
