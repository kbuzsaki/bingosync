...
bingoList[2] = [
  ...
  { name: "Joker's Home Turf - 4+ Story Minikits", types: [] },
...
bingoList[3] = [
  ...
  { name: "Under the City - No Room 1 Out of Bounds", types: [] },
];
bingoList[4] = [
  ...
  { name: "An Icy Reception - 40k Studs", types: [] },
...
bingoList[7] = [
  ...
  { name: "Zoo's Company - 5+ Minikits", types: [] },
...
bingoList[8] = [
  ...
  { name: "Penguin's Lair - 4+ Story Minikits", types: [] },
...
bingoList[9] = [
  ...
  { name: "The Face-Off - 40k Studs", types: [] },
  { name: "To the Top of the Tower - 7+ Minikits", types: [] },
  { name: "To the Top of the Tower - 5+ Story Minikits", types: [] },
...
bingoList[10] = [
  ...
  { name: "The Face-Off - 5+ Story Minikits", types: [] },
  { name: "To the Top of the Tower - Hostage", types: [] },
  { name: "A Surprise for the Commissioner - 6+ Minikits", types: [] },
  { name: "A Surprise for the Commissioner - 4+ Story Minikits", types: [] },
  { name: "Rockin' the Docks - 6+ Minikits", types: [] },
  { name: "Rockin' the Docks - 4+ Story Minikits", types: [] },
];
bingoList[11] = [
  ...
  { name: "Biplane Blast - 15k Studs", types: [] },
...
bingoList[12] = [
  ...
  { name: "The Riddler Makes a Withdrawal - 5+ Story Minikits", types: [] },
  { name: "A Surprise for the Commissioner - Hostage", types: [] },
  { name: "Biplane Blast - 4+ Minikits", types: [] },
...
bingoList[13] = [
  ...
  { name: "Biplane Blast - Red Brick", types: [] },
  { name: "On the Rocks - 6+ Minikits", types: [] },
  { name: "On the Rocks - 4+ Story Minikits", types: [] },
  { name: "Stealing the Show - 7+ Minikits", types: [] },
  { name: "Stealing the Show - 5+ Story Minikits", types: [] },
...
bingoList[14] = [
  ...
  { name: "Biplane Blast - 10 Minikits", types: [] },
  ...
  { name: "Rockin' the Docks - No Birthday Skip", types: [] },
];
bingoList[15] = [
...
bingoList[17] = [
  ...
  { name: "In the Dark Night - 8+ Minikits", types: [] },
  { name: "There She Goes Again - 10 Minikits", types: [] },
  { name: "Under the City - 8+ Minikits", types: [] },
  { name: "You Can Bank on Batman - 9+ Minikits", types: [] },
  { name: "Zoo's Company - 10 Minikits", types: [] },
  { name: "Buy Slam and Fast Build", types: [] },
];
bingoList[18] = [
  { name: "A Daring Rescue - 6+ Minikits", types: [] },
  { name: "A Daring Rescue - 4+ Story Minikits", types: [] },
  ...
  { name: "A Poisonous Appointment - 9+ Minikits", types: [] },
  { name: "3 Story Levels with 1P2C", types: [] },
  { name: "A Surprise for the Commissioner - 9+ Minikits", types: [] },
  { name: "Rockin' the Docks - 9+ Minikits", types: [] },
];
bingoList[19] = [
  { name: "Green Fingers - Red Brick", types: [] },
  { name: "The Joker's Masterpiece - Red Brick", types: [] },
  { name: "The Lure of the Night - 5+ Minikits", types: [] },
  ...
  { name: "Dying of Laughter - 9+ Minikits", types: [] },
];
bingoList[20] = [
  ...
  { name: "Arctic World - 3+ Minikits", types: [] },
  ...
  { name: "The Joker's Masterpiece - 9+ Minikits", types: [] },
];
bingoList[21] = [
  { name: "An Enterprising Theft - Red Brick", types: [] },
  { name: "Arctic World - Red Brick", types: [] },
  { name: "Dying of Laughter - 4+ Minikits", types: [] },
  ...
  { name: "A Daring Rescue - 8+ Minikits", types: [] },
  { name: "The Lure of the Night - 9+ Minikits", types: [] },
];
bingoList[22] = [
  { name: "Buy 3 Goons", types: [] },
  { name: "Joker's Home Turf - Hostage", types: [] },
  { name: "Dying of Laughter - Hostage", types: [] },
  { name: "Breaking Blocks - 9+ Minikits", types: [] },
  ...
  { name: "Arctic World - 9+ Minikits", types: [] },
];
bingoList[23] = [
  ...
  { name: "Joker's Home Turf - Toxic Goo Minikit", types: [] },
];
bingoList[24] = [
  { name: "Arctic World - Hostage", types: [] },
  { name: "Breaking Blocks - Red Brick", types: [] },
  { name: "Dying of Laughter - 40k Studs", types: [] },
  { name: "Joker's Home Turf - 9+ Minikits", types: [] },
  { name: "Little Fun at the Big Top - 9+ Minikits", types: [] },
  { name: "Penguin's Lair - 9+ Minikits", types: [] },
...
bingoList[25] = [
  ...
  { name: "An Icy Reception - 8+ Minikits", types: [] },
  { name: "Batboat Battle - Red Brick", types: [] },
  { name: "Green Fingers - 9+ Minikits", types: [] },
