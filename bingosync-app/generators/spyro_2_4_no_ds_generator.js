...
{ name: "1000 Winter Tundra gems", types: ["hw3"] },
{ name: "1200 Autumn Plains gems", types: ["hw4"] },
{ name: "1000 Summer Forest gems", types: ["hw5"] },
{ name: "Enter 3 inactive portals from out of bounds", types: ["hw6"] },
{ name: "800 Homeworld gems", types: ["hw7"] },
{ name: "7 Homeworld orbs", types: ["hw8"] },
{ name: "Unlock Aquaria, Zephyr and Shady", types: ["hw9"] },
{ name: "100% Summer Forest", types: ["hw10"] }
];
bingoList[7] = [
