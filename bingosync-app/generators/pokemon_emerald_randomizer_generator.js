...
bingoList[6] = [
 ...
 { name: "Dustox or Beautifly", types: ["bugs"] },
 { name: "Nidoking or Nidoqueen", types: ["nido"] },
 { name: "Ludicolo or Shiftry", types: ["leaves"] },
...
bingoList[9] = [
 ...
 { name: "Defeat all 6 trainers on Route 117", types: ["trainer"] },
...
bingoList[10] = [
 ...
 { name: "Masquerain, Ninjask, Ledian, or Ariados", types: ["22/20/18"] }
];
bingoList[11] = [
...
bingoList[12] = [
 ...
 { name: "A trade evolution item", types: ["trade"] }
];
bingoList[13] = [
 { name: "TM27 (Return)", types: ["fallarbor", "tm"] },
 { name: "Lava Cookie", types: ["chimney"] },
...
bingoList[15] = [
 ...
 { name: "Don't use more than one TM", types: ["instant", "tm"] },
...
bingoList[19] = [
 ...
 { name: "Glalie, Sealeo, or Walrein", types: ["trio"] },
...
bingoList[20] = [
 { name: "Solrock or Lunatone", types: ["duo"] },
 { name: "Relicanth or Wailord", types: ["duo"] },
 { name: "Deoxys or Jirachi", types: ["duo"] },
 { name: "Camerupt or Sharpedo", types: ["duo"] },
 { name: "Latias or Latios", types: ["duo"] }
];
bingoList[21] = [
...
bingoList[24] = [
 { name: "$50,000", types: ["mauville", "money"] },
