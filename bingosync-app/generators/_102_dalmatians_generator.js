...
var bingoList = [];
bingoList[1] = [
{"name": "1 up in Regentís Park & 1 up in Barnyard ","types": ["rp,by"]},
...
{"name": "1 up in Hedge Maze & 1 up in De Vilís Manor ","types": ["hm,dvm"]}
];
bingoList[2] = [
{"name": "All bones in Regentís Park" , types: ["rp"] },
...
{"name": "70 bones in De Vilís Manor" , types: ["dvm"] },
{"name": "70 bones in Toy Factory" , types: ["tf"] }
];
bingoList[4] = [
{"name": "All puppies in Regentís Park" , types: ["rp"] },
...
{"name": "All puppies in De Vilís Manor" , types: ["dvm"] },
...
{"name": "7+ puppies in BigBen & De Vilís Manor" , types: ["bb","dvm"] },
...
{"name": "120 combined bones in Piccadilly & De Vilís Manor" , types: ["p","dvm"] },
...
bingoList[8] = [
{"name": "50 bones in both Regent's Park & De Vilís Manor" , types: ["rp","dvm"] },
...
bingoList[9] = [
{"name": "ELP Regentís park & Royal museum" , types: ["rp","rm"] },
...
{"name": "ELP De vilís manor & Lumber mill" , types: ["dvm","lm"] },
{"name": "ELP Ice festival & Hedge maze" , types: ["if","hm"] }
];
bingoList[10] = [
{"name": "ELP Regentís park & The Underground" , types: ["rp","u"] },
...
{"name": "ELP De vilís manor & Ice festival " , types: ["dvm","if"]  }
] ;
bingoList[11] = [
{"name": "ELP Regentís park & Ancient castle" , types: ["rp","ac"] },
...
{"name": "ELP De Vilís Manor & Hedge Maze" , types: ["dvm","hm"] },
{"name": "ELP Piccadilly & Ice Festival" , types: ["p","if"] }
];
bingoList[12] = [
{"name": "ELP Regent's Park & Countryside" , types: ["rp","cs"] },
{"name": "ELP Toy Store & De vilís Manor" , types: ["ts","dvm"] },
...
{"name": "1 puppy from Hedge Maze, Toy Factory & De Vilís Manor" , types: ["hm","tf","dvm"] },
...
{"name": "Destroy 7 different enemiesí types" , types: ["3lvl"] },
...
{"name": "Do 2 Priscillaís tasks " , types: ["by"] },
