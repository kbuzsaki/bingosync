...
{"name": "All bones in Spooky Forest" , types: ["sf"] }
];
bingoList[3] = [
{"name": "70 bones in Toy Store" , types: ["ts"] },
...
{"name": "50 bones in both Toy Store & Countryside" , types: ["ts","cs"] },
...
bingoList[21] = [
{"name": "Destroy 11 devils" , types: ["cs","dvm","c"] },
{"name": "Destroy 6 planes" , types: ["cs","if"] },
{"name": "Destroy 4 boats" , types: ["cs","u","sf"] },
{"name": "Destroy 9 dozers" , types: ["by","lm"] },
{"name": "Destroy 9 helicopter" , types: ["by","sf","bb"] },
{"name": "Destroy 22 soldiers" , types: ["by","sf","ts"] },
{"name": "Destroy 5 penguins" , types: ["if","tf"] },
{"name": "Destroy 4 snowmans" , types: ["if"] },
{"name": "Destroy 4 crocodiles" , types: ["ac","u"] },
{"name": "Destroy 8 teddy bears" , types: ["ac","u","dvm"] },
{"name": "Destroy 5 knights" , types: ["ac","rm"] },
{"name": "Destroy 7 monkeys" , types: ["hm","rp"] },
{"name": "Destroy 9 zepplins" , types: ["hm","bb"] },
{"name": "Destroy 5 toasters" , types: ["dvm","rm"] },
{"name": "Destroy 7 punshing bags" , types: ["ts","tf","bb"] },
{"name": "Destroy 6 jack in box" , types: ["rp","tf","lm"] },
{"name": "Destroy 5 cruella cars" , types: ["rp","p"] },
{"name": "Destroy 5 bomb cars" , types: ["rm","ts"] },
{"name": "Destroy 6 clowns" , types: ["c","p"] },
{"name": "Destroy 13 different enemies' types" , types: ["4lvl"] },
{"name": "Destroy 25 enemies" , types: ["3lvl"] }
];
bingoList[22] = [
...
bingoList[24] = [
{"name": "Use 10 switches" , types: ["by","ac","u","hm","rm","lm"] },
...
{"name": "Collect 20 buried bones" , types: ["4lvl"] },
{"name": "Collect 5 buried bones in 3 levels" , types: ["3lvl"] }
];
bingoList[25] = [
